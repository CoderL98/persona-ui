...
>
  <div class="mx-auto flex max-w-6xl items-center justify-between px-4 py-3">
    ...
    <a
      ...
      aria-label="Persona UI — back to top"
    >
      <span
    ...
    <div class="flex items-center gap-2">
      ...
      <button
        type="button"
        onclick={toggleTheme}
        aria-label="Toggle theme: {theme === 'apple' ? 'Apple' : 'Material'}"
...
<footer class="mt-20 border-t border-(--pui-outline-subtle)">
  ...
  >
    ...
    >
      persona ui · dual-personality component library
    </span>
    <span>v0.1.0 · svelte 5 · tailwind 4</span>
  </div>
</footer>
